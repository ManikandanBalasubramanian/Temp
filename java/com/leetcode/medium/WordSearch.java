...
public class WordSearch {
    ...
    public boolean exist(char[][] board, String word, int i, int j, int index, int m, int n) {
    ...
    public boolean sub(char[][] board, String word, int i, int j, int index, int m, int n, char c) {
        board[i][j] = 0;
